...
public class RankTeamAdapter extends KballBaseAdapter<GetBillboardBean> {
    public RankTeamAdapter(Context context, ArrayList<GetBillboardBean> datas) {
        super(context, datas);
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.rank_team_item, null);
        ...
        ImageLoader.getInstance().displayImage(C.SP.IMG_URL+datas.get(position).getBadge(),holder.rank_img);
        holder.rank_title_tv.setText(datas.get(position).getTeam_name());
        holder.rank_power_tv.setText(datas.get(position).getMean_power());
        return convertView;
    }
