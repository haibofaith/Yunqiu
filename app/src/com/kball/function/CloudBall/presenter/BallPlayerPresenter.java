...
public class BallPlayerPresenter  {
    private BallPlayerImpl mImpl;
    Context mContext;
    public BallPlayerPresenter(Context mContext, BallPlayerImpl mImpl) {
    ...
    public void getdata(String team_id) {
        NetRequest.getInstance().get(mContext, NI.selectTeamMember(team_id), new RequestHandler() {
            @Override
            public void onStart() {
