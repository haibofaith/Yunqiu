...
public class SearchBaseBean<T> implements Serializable {
    private ArrayList<T> team;
    private ArrayList<T> user;
    ...
    public ArrayList<T> getUser() {
        return user;
    }

    public void setUser(ArrayList<T> user) {
        this.user = user;
    }
    ...
    public void setTeam(ArrayList<T> team) {
        this.team = team;
    }
